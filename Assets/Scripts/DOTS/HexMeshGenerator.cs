...
namespace MapGenerationProject.DOTS
{
    public class HexMeshGenerator : MonoBehaviour
    {
        ...
        private void Triangulate()
        {
            ...
            _vertices = new NativeList<Vector3>(5000,Allocator.Persistent);
            _triangles = new NativeList<int>(20000,Allocator.Persistent);
            _colors = new NativeList<Color>(5000,Allocator.Persistent);
            _meshGridData = new HexMeshGridData(_vertices, _triangles, _colors, HexMetrics.NoiseData);
            
            //TODO: Calcular maxCapacity
            ...
            Debug.Log("Triangles: " + _triangles.Length);
        ...
        private struct GenerateCenterHexMeshJob : IJobParallelFor
        {
            ...
            private void TriangulateCornerTerracesCliff(Vector3 begin, HexCellData beginCell, Vector3 left, HexCellData leftCell, Vector3 right, HexCellData rightCell)
            {
                ...
                {
                    MeshGridData.AddTriangleUnperturbed(left, right, boundary, leftCell.Color, rightCell.Color, boundaryColor);
                }
            }
